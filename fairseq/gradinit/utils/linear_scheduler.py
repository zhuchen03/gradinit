...
class LinearSchedule(FairseqLRScheduler):
    ...
    def __init__(self, args, optimizer):
        ...
        self.max_update = args.scheduler_max_update - args.warmup_updates
        self.args = args
    ...
    def add_args(parser):
        ...
        parser.add_argument('--scheduler-max-update', default=100000, type=float, metavar='LR',
                            help='initial learning rate during warmup phase; default is args.lr')
        parser.add_argument('--min-lr', default=0, type=float, metavar='LR',
                            help='initial learning rate during warmup phase; default is args.lr')
        # fmt: on
